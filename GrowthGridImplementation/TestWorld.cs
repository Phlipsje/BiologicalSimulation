...
public class TestWorld : World
{
    ...
    public TestWorld(DataStructure dataStructure, Simulation simulation, float worldHalfSize, bool preciseMovement, bool randomisedExecutionOrder = false) : base(dataStructure, preciseMovement, randomisedExecutionOrder)
    {
